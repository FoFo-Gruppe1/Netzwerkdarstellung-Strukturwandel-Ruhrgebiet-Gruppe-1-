...
function initSigma(config) {
    ...
    if (config.sigma && config.sigma.drawingProperties) {
        ...
        drawProps = {
            ...
            labelThreshold: 10,
            defaultEdgeType: "arrow", // Hier erzwingen wir die Pfeile standardmäßig
            hoverFontStyle: "bold",
            fontStyle: "bold",
    ...
    dataReady = function() {
        ...
        // Kanten-Tuning und Typ-Zuweisung für Pfeile
        a.iterEdges(function (e) {
            e.type = "arrow"; // Typ explizit auf Pfeil setzen
    ...
    if (f.attributes) {
        ...
        for (var attr in f.attributes) {
            ...
            if (attr != image_attribute) {
                e.push('<span><strong>' + attr + ':</strong> ' + d + '</span><br/>');
            }
        }
